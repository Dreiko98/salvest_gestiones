...
final class WebApp
{
    ...
    private function page(string $title,string $body,bool $navigation=true): void
    {
        ...
        echo '<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'.$this->e($title).' · Salvest</title><link rel="stylesheet" href="/assets/app.css"><link rel="stylesheet" href="/assets/actions.css"><script src="/assets/app.js" defer></script></head><body><header><a class="brand" href="/">Gestión de facturas</a>'.$nav.'</header><main>'.$body.'</main></body></html>';
    }
