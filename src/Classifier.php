...
final class Classifier
{
     ...
     *   invoked as ($tier, outcome, details) at every tier boundary. Never affects control flow —
     *   passing null (every caller except `bin/worker.php --debug`) costs nothing extra.
    ...
    /** @param (callable(string,string,array<string,mixed>):void)|null $trace Debug-only observer;
     * see classify()'s docblock — same contract, same zero-cost-when-null guarantee. */
