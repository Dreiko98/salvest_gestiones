...
final class WebApp
{
    ...
    private function dashboard(): void
    {
        ...
        $status=$attention?'<section class="status warning"><div><b>!</b><span><strong>Hay '.$attention.' facturas que necesitan tu ayuda</strong><small>El sistema no ha podido archivarlas automáticamente.</small></span></div><a class="button" href="/reviews">Revisar</a></section>'
    ...
    private function page(string $title,string $body,bool $navigation=true): void
    {
        ...
        $nav=$navigation?'<nav><a href="/">Inicio</a><a href="/communities">Comunidades</a><a href="/suppliers">Proveedores</a><a href="/mailboxes">Correos</a><a href="/storage">Almacenamiento</a><a href="/reviews">Revisar</a><a href="/logout">Salir</a></nav>':'';
